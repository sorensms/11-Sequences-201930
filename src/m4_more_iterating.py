...
def run_test_count_items_bigger_than():
    ...
    # Test 10:
    sequence = [545, 1084, 2032, 17770, -1010, 40]
    threshold = 1000
    expected = 3
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # -------------------------------------------------------------------------
    # Dont: 6. Implement this TEST function.
    ...
    # Test 11:
    expected = 3
    actual = count_positive_sines([13, 6, 24, 17, 107, 89, 92])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 38
    actual = sum_first_n([158, -120, 5, 56], 2)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = -14
    actual = sum_first_n([130, -154, 10, -15], 3)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
